        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    ...
                    dispositivo. Guárdalos en un administrador de contraseñas
                    seguro.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="flex flex-col gap-3 select-none sm:flex-row sm:items-center sm:justify-between">
                    ...
                    >
                        <RecoveryCodeIconComponent
                            ...
                            aria-hidden="true"
                        />
                        {codesAreVisible ? 'Ocultar' : 'Mostrar'} códigos de
                        recuperación
                    </Button>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        una sola vez y se eliminará después. Si
                                        necesitas más, selecciona{' '}
