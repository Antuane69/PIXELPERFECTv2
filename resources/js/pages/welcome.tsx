...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Inicio" />
            <main className="relative flex min-h-svh items-center overflow-hidden p-6 sm:p-10">
                    ...
                    <section className="grid gap-7">
                        ...
                        <div className="grid gap-4">
                            ...
                            <p className="max-w-2xl text-lg text-pretty text-muted-foreground">
                                Gestiona personal, accesos y catálogos desde una
                                experiencia segura, rápida y consistente.
                            </p>
                        </div>
                        <div>
