...
class UpdateEmpleadoDocumentoCatalogoRequest extends FormRequest
{
    public function authorize(): bool
    {
        $documento = $this->route('empleadoDocumentoCatalogo');

        return $documento instanceof EmpleadoDocumentoCatalogo
